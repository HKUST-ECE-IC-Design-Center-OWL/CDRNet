    ...
    def transform(self, data, transform=None, old_origin=None,
        ...
        if 'tsdf_list_full' in data.keys():
            ...
            for l, (tsdf_s, semseg_s) in enumerate(zip(data['tsdf_list_full'], data['semseg_list_full'])):
                ...
                # get correct semseg vol ground truth
                # nearest interpolation, coz value are all int here and indicates id in nyu40
                semseg_vol = torch.nn.functional.grid_sample(
